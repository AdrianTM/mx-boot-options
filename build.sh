...
# Rename files
rename "s/mx-boot-options/$NAME/" *
rename "s/mx-boot-options/$NAME/" translations/*


# Rename strings
find . -type f -exec sed -i "s/mx-boot-options/$NAME/g" {} +
find . -type f -exec sed -i "s/MX Boot Options/$TITLE_NAME/g" {} +
